...
function Intermediate() {
  ...
  const intermediateFilter = trailArr.filter(
    (trail) => trail.difficulty === "Intermediate"
  );
  ...
  return (
    <div className="pages_main">
      <div className="page_inner">
        <div className="pages_header">All Intermediate trails listed</div>
        <div className="pages_inner_div">
          <div className="pages_navlink_divs">
            {intermediateFilter.map((trail, i) => (
